  ...
  return (
    <aside style={{ width: 180, background: 'var(--sidebar)', borderRight: '1px solid var(--line)', display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
      <div style={{ padding: '24px 20px 20px' }}>
        <div className="serif" style={{ fontSize: 15, color: 'var(--text)', fontStyle: 'italic', fontWeight: 300 }}>
          Riad Vision
        </div>
      ...
      <div style={{ padding: '14px 20px', fontSize: 10, color: 'var(--soft)', borderTop: '1px solid var(--line)' }}>
        Bêta privée
      </div>
    </aside>
  )
